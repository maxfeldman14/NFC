...
There are NFC protocols to provide digital signatures, but Android does not implement these.
...
This requires some hacking in order to emulate NFC digital signature standards which Android does not yet support, but we show that a simple API can provide powerful additional security.
