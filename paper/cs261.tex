...
For example, an author with public key $K_a$ may have a record [1:55:$K_a$], indicating that their key is trusted for all URI inputs within the context of that application.
